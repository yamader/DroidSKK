...
import net.dyama.droidskk.databinding.ActivityListBinding
...
class SKKMushroom : AppCompatActivity() {
    ...
    companion object {
        ...
        const val ACTION_BROADCAST = "net.dyama.droidskk.MUSHROOM_RESULT"
        const val CATEGORY_BROADCAST = "net.dyama.droidskk.MUSHROOM_VALUE"
